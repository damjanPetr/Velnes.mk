...
import PopUpBottom from "../components/navigation/PopUpBottom";
...
function Products() {
  ...
  const [layerScreen, setLayerScreen] = useState<boolean>(false);
  const { data, meta, links } = useLoaderData() as {
    data: ProductDetails[];
    meta: PaginationProps["meta"];
    links: PaginationProps["links"];
  };

  console.log(
    "🚀 ✔ file: Products.tsx:30 ✔ const{data}=useLoaderData ✔ data:",
    data,
  );
  ...
  return (
    <div>
      ...
      <div className="p-6">
          ...
          <div className="">
            <div className="flex justify-between gap-5 ">
              ...
              <Button
                ...
                text="New Product"
                type="primary"
                handleClick={() => setLayerScreen(true)}
              ></Button>
            </div>
            ...
            <div className="mt-5">
              <div className="flex gap-5">
                <div className="p-6 ">
                  ...
                  <p className="mt-5 text-2xl font-bold">{meta.total}</p>
                </div>
                <div className="p-6 ">
        ...
        {layerScreen && (
          <LayerScreen>
            <div className="mx-auto w-96 rounded-lg bg-white">
              <PopUpTop
                text="New Product"
                xHandleClick={() => setLayerScreen(false)}
              ></PopUpTop>
              <PopUpBottom>
                <Button text="Save" type="primary" size="large"></Button>
              </PopUpBottom>
            </div>
          </LayerScreen>
        )}
